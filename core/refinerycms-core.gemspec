...
Gem::Specification.new do |s|
  ...
  s.files             = [
    ...
    'lib/generators/templates/config/database.yml.e.mysql',
    'lib/generators/templates/config/database.yml.e.postgresql',
    'lib/generators/templates/config/database.yml.e.sqlite3',
